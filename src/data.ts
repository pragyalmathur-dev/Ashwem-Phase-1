...
export const ASSETS = {
  ...
  renderLEFront: '/assets/renders/LE_Front.jpg',
  fallbackLEFront: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600" viewBox="0 0 800 600"><rect width="100%" height="100%" fill="%232A2926"/><rect width="90%" height="90%" x="5%" y="5%" fill="none" stroke="%23D0C3B5" stroke-width="1" opacity="0.45"/><text x="50%" y="44%" dominant-baseline="middle" text-anchor="middle" font-family="Cardo, serif" font-size="26" fill="%23D0C3B5">La Ermida</text><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="Mulish, sans-serif" font-size="15" fill="%23C0B1A3" font-weight="300" letter-spacing="1px">FRONT ELEVATION VIEW</text><text x="50%" y="58%" dominant-baseline="middle" text-anchor="middle" font-family="Mulish, sans-serif" font-size="12" fill="%239D8E7D">Upload LE_Front.jpg to /assets/renders/ to view</text></svg>',
  
  renderLEPool: '/assets/renders/LE_Pool.jpg',
  fallbackLEPool: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600" viewBox="0 0 800 600"><rect width="100%" height="100%" fill="%232A2926"/><rect width="90%" height="90%" x="5%" y="5%" fill="none" stroke="%23D0C3B5" stroke-width="1" opacity="0.45"/><text x="50%" y="44%" dominant-baseline="middle" text-anchor="middle" font-family="Cardo, serif" font-size="26" fill="%23D0C3B5">La Ermida</text><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="Mulish, sans-serif" font-size="15" fill="%23C0B1A3" font-weight="300" letter-spacing="1px">LUXURY SWIMMING POOL VIEW</text><text x="50%" y="58%" dominant-baseline="middle" text-anchor="middle" font-family="Mulish, sans-serif" font-size="12" fill="%239D8E7D">Upload LE_Pool.jpg to /assets/renders/ to view</text></svg>',
  
  renderLR1to12Front: '/assets/renders/LR_1to12_Front.jpg',
  fallbackLR1to12Front: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600" viewBox="0 0 800 600"><rect width="100%" height="100%" fill="%232A2926"/><rect width="90%" height="90%" x="5%" y="5%" fill="none" stroke="%23D0C3B5" stroke-width="1" opacity="0.45"/><text x="50%" y="44%" dominant-baseline="middle" text-anchor="middle" font-family="Cardo, serif" font-size="26" fill="%23D0C3B5">La Ribera</text><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="Mulish, sans-serif" font-size="15" fill="%23C0B1A3" font-weight="300" letter-spacing="1px">VILLA 1 TO 12 — FRONT VIEW</text><text x="50%" y="58%" dominant-baseline="middle" text-anchor="middle" font-family="Mulish, sans-serif" font-size="12" fill="%239D8E7D">Upload LR_1to12_Front.jpg to /assets/renders/ to view</text></svg>',

  renderLR1to12Back: '/assets/renders/LR_1to12_Back.jpg',
  fallbackLR1to12Back: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600" viewBox="0 0 800 600"><rect width="100%" height="100%" fill="%232A2926"/><rect width="90%" height="90%" x="5%" y="5%" fill="none" stroke="%23D0C3B5" stroke-width="1" opacity="0.45"/><text x="50%" y="44%" dominant-baseline="middle" text-anchor="middle" font-family="Cardo, serif" font-size="26" fill="%23D0C3B5">La Ribera</text><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="Mulish, sans-serif" font-size="15" fill="%23C0B1A3" font-weight="300" letter-spacing="1px">VILLA 1 TO 12 — BACK VIEW</text><text x="50%" y="58%" dominant-baseline="middle" text-anchor="middle" font-family="Mulish, sans-serif" font-size="12" fill="%239D8E7D">Upload LR_1to12_Back.jpg to /assets/renders/ to view</text></svg>',

  renderLR14to20: '/assets/renders/LR_14to20.jpg',
  fallbackLR14to20: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600" viewBox="0 0 800 600"><rect width="100%" height="100%" fill="%232A2926"/><rect width="90%" height="90%" x="5%" y="5%" fill="none" stroke="%23D0C3B5" stroke-width="1" opacity="0.45"/><text x="50%" y="44%" dominant-baseline="middle" text-anchor="middle" font-family="Cardo, serif" font-size="26" fill="%23D0C3B5">La Ribera</text><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="Mulish, sans-serif" font-size="15" fill="%23C0B1A3" font-weight="300" letter-spacing="1px">VILLA 14 TO 20 VIEW</text><text x="50%" y="58%" dominant-baseline="middle" text-anchor="middle" font-family="Mulish, sans-serif" font-size="12" fill="%239D8E7D">Upload LR_14to20.jpg to /assets/renders/ to view</text></svg>',
